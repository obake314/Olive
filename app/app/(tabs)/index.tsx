...
const styles = StyleSheet.create({
  ...
  contentTab: { flex: 1, paddingVertical: 10, alignItems: 'center', backgroundColor: Colors.background },
  contentTabActive: { backgroundColor: Colors.primary },
  contentTabText: { fontSize: 14, fontWeight: '600', color: Colors.textSecondary },
  ...
  todoCount: { fontSize: 14, color: Colors.textSecondary, fontWeight: '600' },
  ...
  todoSectionLabel: { fontSize: 11, fontWeight: '700', color: Colors.textSecondary, letterSpacing: 0.5, marginBottom: 6, paddingHorizontal: 2 },
  todoItemRow: {
  ...
  todoCheckmark: { color: '#fff', fontSize: 12, fontWeight: '700' },
  todoItemBody: { flex: 1 },
  todoItemTitle: { fontSize: 15, color: Colors.text, fontWeight: '500' },
  todoItemTitleDone: { textDecorationLine: 'line-through', color: Colors.textSecondary },
  todoItemDue: { fontSize: 12, color: Colors.textSecondary, marginTop: 2 },
  todoItemDueOverdue: { color: '#e53e3e', fontWeight: '600' },
  todoDeleteText: { fontSize: 13, color: Colors.primaryDark, fontWeight: '700' },
  emptyTodo: { textAlign: 'center', color: Colors.textSecondary, paddingVertical: 40, fontSize: 14 },
  modalBody: { padding: 16 },
  modalLabel: { fontSize: 13, fontWeight: '600', color: Colors.textSecondary, marginBottom: 6, marginTop: 16 },
  toolbar: {
    flexDirection: 'row',
    alignItems: 'center',
