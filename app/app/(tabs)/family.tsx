...
const styles = StyleSheet.create({
  ...
  cardDesc: { fontSize: 13, color: Colors.textSecondary, marginBottom: 16, lineHeight: 20 },
  memberCount: { fontSize: 12, color: Colors.textSecondary, marginBottom: 12 },
  ...
  leaveText: { fontSize: 13, color: Colors.primaryDark, fontWeight: '600' },
  ...
  pendingText: { fontSize: 11, color: Colors.primaryDark, fontWeight: '600' },
});
