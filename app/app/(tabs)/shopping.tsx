...
const styles = StyleSheet.create({
  ...
  customAddBtnText: { color: Colors.primary, fontWeight: '700', fontSize: 16 },
  ...
  checkboxMark: { color: Colors.background, fontSize: 13, fontWeight: '700' },
  itemContent: { flex: 1 },
  ...
  customBadgeText: { fontSize: 13, color: Colors.primaryDark, fontWeight: '600' },
  ...
  addModalTitle: { fontSize: 18, fontWeight: '700', color: Colors.text, marginBottom: 16 },
  modalInput: {
    backgroundColor: Colors.surface,
    borderRadius: 4,
    borderWidth: 1,
  ...
  qtyRow: { flexDirection: 'row', gap: 8, width: '100%' },
  qtyInput: { flex: 1, minWidth: 0, marginBottom: 10 },
  unitInput: { flex: 1, minWidth: 0, marginBottom: 10 },
  ...
  modalSaveText: { color: Colors.background, fontWeight: '700', fontSize: 16 },
